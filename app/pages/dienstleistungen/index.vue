  ...
  <div class="bg-white">
    <section class="relative overflow-hidden bg-gradient-to-br from-ink-900 via-brand-900 to-brand-800 text-white">
      ...
      <div class="container relative py-14 md:py-20">
        <h1 class="text-3xl font-bold tracking-tight text-white md:text-4xl">{{ t('services.section_title') }}</h1>
        <p class="mt-3 max-w-2xl text-ink-100/90">{{ t('services.section_subtitle') }}</p>
      </div>
    </section>
